...
IndoorMap3d = function(mapdiv){
    ...
    //  Conor added: function to highlight a room as you hover the mouse over it
    //  Sourced from here: https://threejs.org/docs/#api/en/core/Raycaster
    //  Note that this currently does not work as intended, more testing is required
    /*
    ...
    */ 
    ...
    function createNameSprites(floorId){
        ...
        var funcAreaJson = _this.mall.getFloorJson(_this.mall.getCurFloorId()).Rooms;
