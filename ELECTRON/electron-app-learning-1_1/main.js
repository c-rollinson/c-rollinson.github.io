...
ipcMain.on("btnclick_6",  (e6, arg) => {
  ...
  e6.sender.send("button_6-task-finished", "yes");
});


//  New window 5: 3D map tool
ipcMain.on("btnclick_7",  (e7, arg) => {
  ...
  e7.sender.send("button_7-task-finished", "yes");
});
